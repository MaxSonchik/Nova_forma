...
class WarehouseTab(QWidget):
    ...
    def setup_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(["Тип", "Артикул", "Наименование", "Количество", "Ед. изм."])
        
        # Настройка ширины
        header = self.table.horizontalHeader()
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.Stretch) # Наименование тянется
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents) # Тип по ширине текста
    ...
    def populate_table(self, items):
        ...
        for row_idx, item in enumerate(items):
            ...
            if item_type == 'Материал': icon_name = 'fa5s.layer-group'
            elif item_type == 'Заготовка': icon_name = 'fa5s.puzzle-piece'
            elif item_type == 'Изделие': icon_name = 'fa5s.chair'
