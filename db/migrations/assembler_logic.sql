-- ПРОЦЕДУРА: Сдать работу (Сборщик сделал детали)
...
DECLARE
    ...
    v_fact_qty INTEGER;
BEGIN
    -- 1. Получаем текущие данные задания
